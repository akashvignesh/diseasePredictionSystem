...
import requests
TestData = pd.read_csv(r".\Model\diabetes.csv") 
...
import json
json.dump(streamlit_field_data, open(r".\Application\front_end\streamlit_options.json", "w"), indent=2)
StreamLit_SlideBar= json.load(open(r".\Application\front_end\streamlit_options.json"))
